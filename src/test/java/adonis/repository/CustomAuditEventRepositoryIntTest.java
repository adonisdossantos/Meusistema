package adonis.repository;

import adonis.MeusistemaApp;
import adonis.config.Constants;
import adonis.config.audit.AuditEventConverter;
import adonis.domain.PersistentAuditEvent;
...
import static adonis.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
